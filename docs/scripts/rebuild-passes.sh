#!/bin/bash
# rebuild-passes.sh — walk every decoded_* directory, read its meta.json,
# list the PNGs, derive the pass direction, and write a single passes.json
# that the gallery frontend consumes. Run after every decode.
#
# NOTE: set BASE_DIR to wherever your decoded_* folders and passes.json live.
BASE_DIR="/home/USER/satellite-images"
